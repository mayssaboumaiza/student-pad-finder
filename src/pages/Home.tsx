...
const Home = () => {
  ...
  const locations = [
    ...
    "Gabès", "Medenine", "Tataouine", "Tozeur", "Kebili", "Gafsa"
  ];
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              onClick={() =>
                navigate(`/list?type=recommended&location=${encodeURIComponent(location)}`)
              }
            >
              Voir tous
            </button>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              className="text-sm text-primary"
              onClick={() =>
                navigate(`/list?type=nearby&location=${encodeURIComponent(location)}`)
              }
            >
              Voir tous
            </button>
